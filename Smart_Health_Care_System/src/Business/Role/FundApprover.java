...
import userinterface.FundApprover.FundApproverWorkAreaJPanel1;
 ...
 * @author Apoorva
 */
public class FundApprover extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, USA_Smart_HealthCare business,
            Network network) {
        return new FundApproverWorkAreaJPanel1(userProcessContainer, account, organization, business);
