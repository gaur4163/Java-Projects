 ...
 * @author Gaurav
 */
public class QualityMaintenanceStaffWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public QualityMaintenanceStaffWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, WaterQualityMonitoring business) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : maintenanceOrg.getWorkQueue().getWorkRequestList()){
            if(request instanceof QualityMaintenanceWorkRequest){
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 760, 150));
        ...
        add(assignJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 470, 150, 30));
        ...
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 470, 150, 30));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 230, 140, 30));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(51, 51, 255));
        jLabel5.setText("Water Quality Maintenance Staff Work Requests");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 580, 40));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 590, 100, -1));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
          try{
               ...
               JOptionPane.showMessageDialog(null, "Please choose Atleast one Request", "WARNING", JOptionPane.WARNING_MESSAGE); 
                ...
                QualityMaintenanceWorkRequest requestA = (QualityMaintenanceWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
          ...
          JOptionPane.showMessageDialog(null, "First Assign the Request to you", "ERROR", JOptionPane.ERROR_MESSAGE);    
                     ...
                     ProcessQualityRequestJPanel processQualityRequestJPanel = new ProcessQualityRequestJPanel(userProcessContainer, requestA);
        userProcessContainer.add("ProcessQualityRequestJPanel", processQualityRequestJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
                requestA.setQualityMaintenanceAlert("Reaching the location for Maintenance");
